...
const Dashboard = () => {
  ...
  const [form, setForm] = useState({ nomeEntregador: '', cliente: '', volume: '', status: 'Em andamento', tempoEstimado: '', tempoDecorrido: 0 });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ nomeEntregador: '', cliente: '', volume: '', status: 'Em andamento', tempoEstimado: '', tempoDecorrido: 0 });
    } catch (error) {
