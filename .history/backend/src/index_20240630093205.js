...
const entregadorRoutes = require('./routes/entregadorRoutes');  // Certifique-se de que esta linha está correta
...
app.use('/entregadores', entregadorRoutes);  // Certifique-se de que esta linha está correta
